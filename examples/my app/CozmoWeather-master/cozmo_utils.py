...
def get_icon_for_forecast(forecast):
    ...
    if "cloud" in forecast:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/cloudy.png"
    elif "sunny" in forecast:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/sunny.png"
    elif "rain" in forecast:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/rainy.png"
    elif "snow" in forecast:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/snow.png"
    elif "storm" in forecast:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/storm.png"
    else:
        return "C:/wamp64/www/cozmo-python-sdk/examples/my app/CozmoWeather-master/images/unknown.png"
